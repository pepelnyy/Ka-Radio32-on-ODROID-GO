...
2. The sound quality on built-in speaker is not very good. I strongly recommend to use some external DAC. I will tell about it [below](KaRadio32-on-ODROID-GO/ODROID-GO.md#using-of-external-dac).
